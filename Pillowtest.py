...
def generate_image(outfit):
    ...
    # Arms
    d.rectangle([50, 120, 80, 260], fill=shadow, outline="black")
    d.rectangle([180, 120, 210, 260], fill=shadow, outline="black")
    ...
    # Shoes
    d.rectangle([90, 400, 130, 420], fill=(40, 40, 40), outline="black")
    d.rectangle([130, 400, 170, 420], fill=(40, 40, 40), outline="black")
