...
def generate_image(outfit):
    img = Image.new("RGB", (240, 420), "white")
    d = ImageDraw.Draw(img)

    d.rectangle([80, 40, 160, 140], outline="black", width=3)   # Head
    d.rectangle([60, 140, 180, 250], outline="black", width=3) # Outer
    d.rectangle([75, 155, 165, 235], outline="gray", width=2)  # Inner
    d.rectangle([75, 250, 165, 390], outline="black", width=3) # Bottom

    d.text((10, 10), outfit["Color Theme"], fill="black")
    return img
